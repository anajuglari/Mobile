...
videoButton: { backgroundColor: '#99cd85', padding: 15, borderRadius: 12, marginBottom: 20 },
...
categoryBadge: {
backgroundColor: '#cfe0bc', // Verde para diferenciar dos ingredientes
paddingVertical: 6,
...
categoryBadgeText: { color: '#6EB680', fontWeight: 'bold', textTransform: 'uppercase', fontSize: 14 },
...
marginBottom: 15,
borderLeftWidth: 6,
borderLeftColor: '#99cd85'
},
stepNum: { fontSize: 12, fontWeight: 'bold', color: '#6EB680', marginBottom: 4 },
stepText: { fontSize: 17, color: '#333', lineHeight: 24 },

homeButton: { backgroundColor: '#99cd85', padding: 20, borderRadius: 15, marginTop: 20, marginBottom: 40 },
