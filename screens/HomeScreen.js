...
const RECEITAS_INICIAIS = [
 ...
 videoUrl: 'https://raw.githubusercontent.com/anajuglari/Mobile/main/videos/pao-de-queijo.mp4?raw=true'
 },
 { 
 id: "2", 
 nome: 'Brownie', 
 ...
 videoUrl: 'https://raw.githubusercontent.com/anajuglari/Mobile/main/videos/brownie.mp4?raw=true' 
 },
 { 
 id: "3", 
...
"Cobertura":[
 ...
 passos: 
 {"Massa":[
 "1. Bata no liquificador",
 "2. Em uma panela coloque o leite condensado, a manteiga e o chocolate em pó.",
...
"Recheio":[
 ...
 videoUrl: 'https://raw.githubusercontent.com/anajuglari/Mobile/main/videos/torta-de-limao.mp4?raw=true' 
},
]
...
setCarregando(true);
try {
const response = await fetch('https://raw.githubusercontent.com/anajuglari/Mobile/refs/heads/main/receitas.json?raw=true');
...
btnSync: { backgroundColor: '#99cd85', margin: 20, padding: 15, borderRadius: 12, alignItems: 'center' },
...
card: { width: '100%', height: 160, borderRadius: 15, overflow: 'hidden', backgroundColor: '#cfe0bc' },
image: { width: '100%', height: '100%', resizeMode: 'cover' },
cardOverlay: { position: 'absolute', bottom: 0, width: '100%', backgroundColor: '#99cd85', padding: 8 },
recipeTitle: { color: '#fff', fontWeight: 'bold', textAlign: 'center', fontSize: 12 },
deleteBtn: { position: 'absolute', top: -10, right: -10, backgroundColor: 'white', width: 28, height: 28, borderRadius: 14, justifyContent: 'center', alignItems: 'center', zIndex: 99 },
deleteText: { color: '#99cd85', fontWeight: 'bold' }
});
