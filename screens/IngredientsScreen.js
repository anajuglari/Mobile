...
recipeSubtitle: { fontSize: 24, fontWeight: 'bold', color: 'black', marginBottom: 15 },
...
itemText: { marginLeft: 10, fontSize: 16, color: 'black', flex: 1 },
checkedText: { textDecorationLine: 'line-through', color: 'white' },
button: {
backgroundColor: '#99cd85',
padding: 18,
borderRadius: 15,
